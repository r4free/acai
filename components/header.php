<div class="page-header hidden-sm hidden-xs" id="header">
  <div class="container">
    <div class="row">
      <div class="col-md-2">
      ...
      <div class="col-md-10">
        ...
        <ul class="nav navbar-nav pull-right">
          ...
          <li><a href="#"><img src="img/whatsapp.svg" alt="whatsapp logo"></a></li>
          <li><a href="#"><img src="img/youtube.svg" alt="youtube logo"></a></li>
